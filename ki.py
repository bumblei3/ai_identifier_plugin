...
async def get_genre_suggestion(title: str, artist: str, tagger=None, file_name: Optional[str]=None) -> Optional[str]:
    log_event("debug", "KI-Funktion get_genre_suggestion aufgerufen", title=title, artist=artist, file=file_name)
    """
    ...
    log_event("debug", "KI-Funktion Ergebnis", result=genre)
    return genre

async def get_style_suggestion(title: str, artist: str, tagger=None, file_name: Optional[str]=None) -> Optional[str]:
    log_event("debug", "KI-Funktion get_style_suggestion aufgerufen", title=title, artist=artist, file=file_name)
    """
    ...
    log_event("debug", "KI-Funktion Ergebnis", result=style)
    return style

async def get_language_code_suggestion(title: str, artist: str, tagger=None, file_name: Optional[str]=None) -> Optional[str]:
    log_event("debug", "KI-Funktion get_language_code_suggestion aufgerufen", title=title, artist=artist, file=file_name)
    """
    ...
    log_event("debug", "KI-Funktion Ergebnis", result=lang_code)
    return lang_code
